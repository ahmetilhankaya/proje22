...
# eğer mouse siyah çubuğun alanındaysa y ekseninde kırmızı kutuyu hareket ettir.
        ...
        # uzunluk çubuğu ve hareket eden kutu
        ...
        screen.blit(division_l, division_l_text)
        ...
        # kabloyu çizmek
        # kablo için 2 elips 1 dikdörtgen kullandık
        # dikdörtgeninin başı ve sonu elipslerin tam ortasından geçecek
        # kablo varmış gibi bir görüntü elde ederiz
        ...
        ((ellipse_start.x, ellipse_start.y - 50), (ellipse_start.x, ellipse_start.y - 30),
                (ellipse_start.x + 100, ellipse_start.y -30), (ellipse_start.x + 100, ellipse_start.y - 20), (ellipse_start.x + 120, ellipse_start.y - 40),
                (ellipse_start.x + 100, ellipse_start.y - 60), (ellipse_start.x + 100, ellipse_start.y -50)))
